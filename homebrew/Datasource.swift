...
class Datasource {
    ...
    private static func inMemory() -> NSPersistentCloudKitContainer {
        ...
        let _ = BrewBuilder(context: viewContext)
                .withDetails(name: "Traditional Mead", date: "01/17/2020", og: 1.11, category: .MEAD)
                .withSecondary(date: "03/01/2020", gravity: 1.00)
                .withBottle(date: "04/18/2020", fg: 1.00, count: 20)
                .build()
        let _ = BrewBuilder(context: viewContext)
                .withDetails(name: "IPA Beer", date: "06/12/2021", og: 1.052, category: .BEER)
                .withBottle(date: "07/01/2021", fg: 1.010, count: 50)
                .build()
        let _ = BrewBuilder(context: viewContext)
                .withDetails(name: "Red Wine", date: "01/30/2021", og: 1.080, category: .WINE)
                .withSecondary(date: "03/15/2021", gravity: 0.998)
                .withBottle(date: "04/12/2021", fg: 0.998, count: 20)
                .build()
        let _ = BrewBuilder(context: viewContext)
                .withDetails(name: "Blueberry Mead", date: "06/21/2021", og: 1.115, category: .MEAD)
                .build()
        let _ = BrewBuilder(context: viewContext)
                .withDetails(name: "Strawberry Mead", date: "07/13/2021", og: 1.103, category: .MEAD)
                .build()
        let _ = BrewBuilder(context: viewContext)
                .withDetails(name: "Lager Beer", date: "09/13/2021", og: 1.048, category: .BEER)
                .build()
        do {
